...
function loadWebStats(url, showIsAdmin, showModVersion) {
	...
	$.get(url, function(data){
		...
		if (Server != null) {
			...
			$("#webStatsDayTime").text($(Server).attr("dayTime"));
			...
			var webStatsFields = $("#webStatsFields");
			var Fields = $(data).find("Server Fields Field");
			if (webStatsFields != null && Fields != null) {
				Fields.each(function(index, element) {
					var Fields = $(element);
							
					webStatsFields.append("<tr><td>"+Fields.attr("number")+"</td><td>"+Fields.attr("owned")+"</td><td>"+Fields.attr("area")+"</td><td>"+Fields.attr("price")+"</td><td>"+Fields.attr("xPos")+" "+Fields.attr("zPos")+"</td></tr>");
				});
			}		
